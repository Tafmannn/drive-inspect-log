-- Rollback for 20260713120000_submit_inspection_server_side_job_lock.sql
-- Restores submit_inspection() to its exact prior body from
-- 20260629100000_fix_damage_items_replay_ordering.sql (removes the
-- JOB_NOT_ACTIONABLE / ACTIVE_JOB_LOCK server-side checks; everything else
-- identical).
