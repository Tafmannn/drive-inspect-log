-- Rollback for 20260713170000_delivery_requires_pickup_complete.sql
-- Restores submit_inspection() to its exact prior body from
-- 20260713150000_submit_inspection_assigned_driver_only.sql (removes the
-- PICKUP_NOT_COMPLETE check; keeps the NOT_ASSIGNED_DRIVER check from that
-- migration, since this migration built on top of it).
